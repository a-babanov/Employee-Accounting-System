...
router.post("/employee/edit", function(request, response){
    if(!request.body)
        return response.sendStatus(400);
    console.log(request.body);
...
router.post("/employee/holiday", function(request, response){
    if(!request.body)
        return response.sendStatus(400);
    console.log(request.body);
...
router.post("/employee/businessTrip", function(request, response){
    if(!request.body)
        return response.sendStatus(400);
    console.log(request.body);
    const id = parseInt(request.body.id);
...
router.post("/employee/sickDays", function(request, response){
    if(!request.body)
        return response.sendStatus(400);
    console.log(request.body);
    const id = parseInt(request.body.id);
