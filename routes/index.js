...
router.post('/save/:employeeId', indexController.postSave);

//Маршрут на обработку формы отпросился
router.post("/getAway/:employeeId", indexController.postGetAway);

//Маршрут на обработку запроса формы встречи
router.post("/meeting/:employeeId", indexController.postMeeting);
