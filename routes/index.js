...
router.post('/save/:employeeId', function(request, response) {
    if(!request.body)
        return response.sendStatus(400);
...
router.post("/getAway/:employeeId", function(request, response){
    if(!request.body)
        return response.sendStatus(400);
...
router.post("/meeting/:employeeId", function(request, response){
    if(!request.body)
        return response.sendStatus(400);
    console.log(request.body);
